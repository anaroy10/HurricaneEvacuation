...
It computes evacuation policies using value iteration over belief states.

## Main Files
- `main.py` — entry point
- `mdp_solver.py` — value iteration and policy computation
- `belief_state_mdp.py` / `belief_space_mdp.py` — belief-state modeling
- `graph_parser.py` — graph and input parsing
